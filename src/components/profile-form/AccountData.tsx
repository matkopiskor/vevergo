        ...
        <Row gutter={[30, 0]}>
            ...
            <FormCol>
                <Item name="first_name">
                    <Input label={t('lblFirstName')} disabled />
                </Item>
            </FormCol>
            <FormCol>
                <Item name="last_name">
                    <Input label={t('lblLastName')} disabled />
                </Item>
            </FormCol>
            <FormCol>
                <Item name="country">
            ...
            <FormCol>
                <Item name="language">
                    <Select label={t('lblCountry')} options={languageOptions} disabled />
                </Item>
            </FormCol>
            <FormCol>
                <Item name="currency">
                    <Select label={t('lblCurrency')} options={currencyOptions} disabled />
                </Item>
            </FormCol>
            <FormCol>
                <Item name="timezone">
                    <Select label={t('lblTimeZone')} options={[]} disabled />
                </Item>
            </FormCol>
            <FormCol>
